...
<head>
    <meta charset="utf-8">
    <title>Tutorial: topology - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">Tutorial: topology</h1>
...
<article>
    <p>PubNub Channel Topology:</p>
<pre class="prettyprint source"><code>&quot;demo&quot; == ChatEngine.globalChat.channel;
...
demo.privChat.$typingIndicator.startTyping</code></pre>
</article>
