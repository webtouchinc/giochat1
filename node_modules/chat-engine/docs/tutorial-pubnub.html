...
<head>
    <meta charset="utf-8">
    <title>Get PubNub Keys - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">Get PubNub Keys</h1>
...
<header>
    ...
    <!-- <h2>Get PubNub Keys</h2> -->
</header>

<article>
    <h1>Automagic PubNub Setup</h1><p>In order to get set up as fast as possible, you can login into the form below with your PubNub credentials.</p>
<p>This will automatically create a new ChatEngine App in your PubNub account, an new key pair, and enable all the PubNub features required for ChatEngine to work properly.</p>
