...
<p>When the ChatEngine#connect method is invoked, ChatEngine will make an authentication request to <code>ceConfig.authUrl</code>. This url is responsible for granting the uuid permission to access the network.</p>
