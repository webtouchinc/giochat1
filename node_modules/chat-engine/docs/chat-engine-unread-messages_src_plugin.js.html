...
<head>
    <meta charset="utf-8">
    <title>chat-engine-unread-messages/src/plugin.js - Documentation</title>
...
module.exports = () => {
    ...
    class extension {
        ...
        construct(data) {
            ...
            /**
            * Adds the property Chat.isFocused to the applied Chat.
            * @member unreadMessages"."isFocused
            * @ceextends Chat
            */
